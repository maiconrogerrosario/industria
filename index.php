...
$route->get("/work", "Work:work");
$route->post("/work", "Work:work");
$route->get("/work/all/{page}", "Work:work");

$route->get("/works", "Work:work");
$route->post("/works", "Work:work");
$route->get("/works/all/{page}", "Work:work");

$route->get("/works-add", "Work:workAdd");
$route->post("/works-add", "Work:workAdd");
$route->get("/works-edit/{work_id}", "Work:workEdit");
$route->post("/works-edit/{work_id}", "Work:workEdit");
$route->get("/works-delete/{work_id}", "Work:work");
$route->post("/works-delete/{work_id}", "Work:work");
$route->get("/project/{project_id}", "Work:project");
$route->post("/project/{project_id}", "Work:project");
$route->get("/cronograma/{project_id}", "Work:cronograma");
$route->post("/cronograma/{project_id}", "Work:cronograma");
...
/** Start Modals Work*/
$route->post("/modalstage", "Work:modalstage");
$route->get("/modalstage", "Work:modalstage");
$route->post("/modalstage/{stage_id}", "Work:modalStage");
$route->get("/modalstage/{stage_id}", "Work:modalStage");
$route->post("/modaltask", "Work:modalTask");
$route->get("/modaltask", "Work:modalTask");
$route->post("/modaltask/{task_id}", "Work:modalTask");
$route->get("/modaltask/{task_id}", "Work:modalTask");
$route->post("/deletetask/{task_id}", "Work:modalTask");
$route->get("/deletetask/{task_id}", "Work:modalTask");
$route->post("/modalprojectfile", "Work:modalProjectFile");
$route->get("/modalprojectfile", "Work:modalProjectFile");
$route->post("/modalprojectfile/{project}", "Work:modalProjectFile");
$route->get("/modalprojectfile/{project}", "Work:modalProjectFile");
$route->post("/modalimportinvoices", "Work:modalImportInvoices");
$route->get("/modalimportinvoices", "Work:modalImportInvoices");
$route->post("/modalimportinvoices/{id}", "Work:modalImportInvoices");
$route->get("/modalimportinvoices/{id}", "Work:modalImportInvoices");
...
/**Start Suppliers */
$route->get("/supplier", "Work:supplier");
$route->post("/supplier", "Work:supplier");
$route->get("/supplier-add", "Work:supplierAdd");
$route->post("/supplier-add", "Work:supplierAdd");
$route->get("/supplier-edit/{supplier_id}", "Work:supplierEdit");
$route->post("/supplier-edit/{supplier_id}", "Work:supplierEdit");
$route->get("/supplier-delete/{supplier_id}", "Work:supplier");
$route->post("/supplier-delete/{supplier_id}", "Work:supplier");
/**End Suppliers*/

/**Start Suppliers Category */
$route->get("/supplier-category", "Work:supplierCategory");
$route->post("/supplier-category", "Work:supplierCategory");
$route->get("/supplier-category-add", "Work:supplierCategoryAdd");
$route->post("/supplier-category-add", "Work:supplierCategoryAdd");
$route->get("/supplier-category-delete/{id}", "Work:supplierCategory");
$route->post("/supplier-category-delete/{id}", "Work:supplierCategory");
/**End Suppliers Category */

/** Start Stage Category*/
...
/** Start Stage*/
$route->get("/stage-add", "Work:stageAdd");
$route->post("/stage-add", "Work:stageAdd");
$route->get("/stage", "Work:stage");
$route->post("/stage", "Work:stage");
/** End Stage */

/** Start Service Category */
$route->get("/service-category", "Work:serviceCategory");
$route->post("/service-category", "Work:serviceCategory");
$route->get("/service-category-add", "Work:serviceCategoryAdd");
$route->post("/service-category-add", "Work:serviceCategoryAdd");
$route->get("/service-category-delete/{id}", "Work:serviceCategory");
$route->post("/service-category-delete/{id}", "Work:serviceCategory");
...
/**Start Botões de Status*/
$route->post("/stagestatus", "Work:stagestatus");
$route->post("/taskstatus", "Work:taskstatus");
/**End Botões de Status*/

/** Start Project File */
$route->get("/equipment-file", "Work:projectFile");
$route->post("/equipment-file", "Work:projectFile");
$route->get("/equipment-file/all/{page}", "Work:projectFile");
$route->get("/equipment-file-add", "Work:projectFileAdd");
$route->post("/equipment-file-add", "Work:projectFileAdd");
$route->get("/equipment-file-delete/{id}", "Work:projectFile");
$route->post("/equipment-file-delete/{id}", "Work:projectFile");

...
class Clinic extends Controller
{
    ...
    */
    public function manageServices(): void
    {
        ...
        echo $this->view->render("manage-services", [
            "head" => $head,
    ...
    */
    public function addServices(): void
    {
        ...
        echo $this->view->render("add-services", [
            "head" => $head
    ...
    */
    public function editServices(): void
    {
        $head = $this->seo->render(
            "Olá {$this->user->first_name}. Vamos controlar? - " . CONF_SITE_NAME,
            CONF_SITE_DESC,
    ...
    *Clinic Edit Services
    */
    public function appointmentAdd(): void
    {
        $head = $this->seo->render(
            "Olá {$this->user->first_name}. Vamos controlar? - " . CONF_SITE_NAME,
            CONF_SITE_DESC,
        ...
        echo $this->view->render("appointment-add", [
            "head" => $head
    ...
    */
    public function appointmentEdit(): void
    {
        ...
        echo $this->view->render("appointment-edit", [
            "head" => $head
    ...
    public function customer(?array $data): void
    {
        ...
        if (!empty($data["action"]) && $data["action"] == "delete") {
            ...
            if (!$customerDelete) {
                ...
                $this->message->error("Você tentnou deletar um fornecedor que não existe")->flash();
                echo json_encode(["redirect" => url("/clinic/customer")]);
                return;

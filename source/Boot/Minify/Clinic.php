...
if (strpos(url(), "localhost")) {
    ...
    //theme CSS
    $cssDir = scandir(__DIR__ . "/../../../themes/" . CONF_VIEW_CLINIC . "/assets/css");
    foreach ($cssDir as $css) {
        $cssFile = __DIR__ . "/../../../themes/" . CONF_VIEW_CLINIC . "/assets/css/{$css}";
    ...
    //Minify CSS
    $minCSS->minify(__DIR__ . "/../../../themes/" . CONF_VIEW_CLINIC . "/assets/style.css");
    ...
    //theme CSS
    $jsDir = scandir(__DIR__ . "/../../../themes/" . CONF_VIEW_CLINIC . "/assets/js");
    foreach ($jsDir as $js) {
        $jsFile = __DIR__ . "/../../../themes/" . CONF_VIEW_CLINIC . "/assets/js/{$js}";
    ...
    //Minify JS
    $minJS->minify(__DIR__ . "/../../../themes/" . CONF_VIEW_CLINIC . "/assets/scripts.js");
}
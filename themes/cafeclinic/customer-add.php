    ...
    <!-- begin dashhead -->
		<div class="dashhead bg-white">
            <div class="dashhead-titles">
				<h3 class="dashhead-title">Cadastro de Clientes</h3>
            ...
            <div class="row">
                <div class="col-xs-12">
					<div class="box">
						...
						<div class="box-body">
							<form class="form-horizontal" action="<?= url("/clinic/customer-add"); ?>" method="post">
								<div>
									<section>
										...
										<div class="form-group">
											...
											<div class=" col-md-6">
												...
												<input type="text" class="form-control mask-doc2" id="document" placeholder="CPF/CNPJ" name="document"/>
											</div>
										</div>
										<div class="form-group">
											<div class="col-md-12">

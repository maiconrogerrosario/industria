	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="card-content table-responsive">
				<a href="<?= url("/app/equipment-category-add"); ?>" title="Cadastrar Nova Categoria" class="btn btn-primary"><i class='fa fa-fw fa-th-list'></i>Nova Categoria</a>
				<br><br>
                       ...
                       <?php foreach ($categories as $categorie):?>
						<tr>
							...
							<a class="btn-simple btn btn-danger btn-xs" title="Apagar Esta Categoria" href="#"
                                data-post="<?= url("/app/equipment-category-delete/{$categorie->id}"); ?>"
                                data-action="delete"

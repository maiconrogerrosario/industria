			...
			<div class="container-fluid p-t-15">
				<div class="row">
					<div class="col-xs-12">
						<div class="box">
							<header>
								<h4>Cadastro de Nova Etapa<small></small></h4>
								<!-- begin box-tools -->
								<!--<div class="box-tools">
							...
							<div class="box-body">
								<form class="form-horizontal" action="<?= url("/work/stage-add"); ?>" method="post">
											...
											<section>
												...
												<div class="form-row">
													<div class="form-group">
														<div class="col-md-12">
															<label for="name">Obra Ativa</label>

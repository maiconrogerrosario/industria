			...
			<div class="container-fluid p-t-15">
				<div class="row">
					<div class="col-xs-12">
						<div class="box">
							<header>
								<h4>Cadastro de Novas Categorias de Fornecedores<small></small></h4>
								<!-- begin box-tools -->
								<!--<div class="box-tools">
							...
							<div class="box-body">
								<form class="form-horizontal" action="<?= url("/work/supplier-category-add"); ?>" method="post">
										<div>
											<section>
												<div class="form-row">
												...
												<div class="form-group">
													<div class="col-lg-12">
														<button class="btn btn-primary">Cadastrar Nova Categoria</button>
													</div>
												</div>		

	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="container-fluid p-t-15">
				...
				<a href="<?= url("/work/supplier-category-add"); ?>" class="btn btn-primary"><i class='fa fa-fw fa-male'></i>Novo Categoria de Fornecedor</a>
				<br><br>
					...
					<?php if (!empty($categories)): ?>
						...
						<tr scope="row">
							...
							<a class="btn-simple btn btn-danger btn-xs" title="" href="#"
                                data-post="<?= url("/work/supplier-category-delete/{$categorie->id}"); ?>"
                                data-action="delete"

            ...
            <div class="container-fluid p-t-15">
              ...
              <div class="row">
                <div class="col-xs-12">
                  <div class="box">
                    <header>
                      <h4>Cadastro de Obra ou Serviços<small></small> </h4>
                      <!-- begin box-tools -->
                      <!--<div class="box-tools">
                      ...
                      <form class="form-horizontal" action="<?= url("/work/work-add"); ?>" method="post">
                        ...
                        <div>
							<section>
								...
								<div class="form-group">
									<div class="col-md-12">
										<label for="name">Nome da Obra ou Serviço</label>
								...
								<div class="form-group">
									<div class="col-md-6">
										<label for="date_initial">Data de Início da Obra</label>
								...
								<div class="form-group">
									<div class="col-lg-12">
										<button class="btn btn-primary">Cadastrar Obra ou Serviço</button>
									</div>
								</div>				
							</section>
                        </div>

...
<head>
   ...
   <link rel="stylesheet" href="<?= url("/shared/assets/css/vendor.css"); ?>"/>
	...
	<link rel="stylesheet" href="<?= url("/shared/scripts/fullcalendar/fullcalendar.min.css"); ?>" />
	<link  href="<?= url("/shared/css/main.css"); ?>" rel='stylesheet'/>
	
	<link rel="stylesheet" href="<?= url("/shared/scripts/select2/css/select2.min.css"); ?>" rel="stylesheet"/>
...
<div class="ajax_response"><?= flash(); ?></div>
             ...
             <!-- <li class="visible-xs b-l">
              ...
              <li class="dropdown b-l">
                <a class="dropdown-toggle profile-pic" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                    ...
                    <?php else: ?>
                        <img class="img-circle" alt="<?= user()->first_name; ?>" title="<?= user()->first_name; ?>"
                             src="<?= theme("/assets/images/avatar.jpg", CONF_VIEW_WORK); ?>"/>
                    <?php endif; ?>
  ...
  <script   src="<?= theme("/assets/scripts.js", CONF_VIEW_WORK); ?>"></script>
  <script  src="  <?= url("/shared/scripts/select2.min.js");?>"></script>
  <?= $v->section("scripts"); ?>

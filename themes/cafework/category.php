        ...
        <div class="container-fluid p-t-15">
			<div class="row">
				<div class="col-xs-12">
					<div class="box">
							<header>
								<h3>Categoria de Receita e Despesas</h3>
								<div class="box-tools">
								</div>
							</header>	
						<div class="box-body">
					
							<a href="<?= url("/work/category-add"); ?>" class="btn btn-primary"><i class='fa fa-i fa-plus-circle'></i>Novo</a>
										...
										<?php foreach ($categories as $categorie):?>
											<tr scope="row">
												<td scope="col" style="text-align:center;font-size:12px;"><?php echo $categorie->name;?></td>
													<td scope="col" style="text-align:center;font-size:12px;"><?php if($categorie->type == "income") {
														
														echo "Receita";
														
													}else if($categorie->type == "expense") {
												...
												<td scope="col" style="text-align:center;font-size:12px;">
													<a class="btn-simple btn btn-danger btn-xs" title="" href="#"
														data-post="<?= url("/work/category-delete/{$categorie->id}"); ?>"
														data-action="delete"

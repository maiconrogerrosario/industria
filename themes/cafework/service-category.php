				...
				<div class="col-xs-12">
					<div class="box">
						...
						<div class="box-body">
							...
							<a href="<?= url("/work/service-category-add"); ?>" class="btn btn-primary"><i class='fa fa-i fa-plus-circle'></i>Novo</a>
											...
											<tr scope="row">
												...
												<td scope="col" style="text-align:center;font-size:12px;">
													<a class="btn-simple btn btn-danger btn-xs" title="" href="#"
														data-post="<?= url("/work/service-category-delete/{$categorie->id}"); ?>"
														data-action="delete"

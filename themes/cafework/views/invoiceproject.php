<div class="cafecontrol_modal_box cafecontrol_modal_project_<?= $type; ?>">
    ...
    <form class="cafecontrol_form" action="<?= url("/work/launch"); ?>" method="post">
        ...
        <input type="hidden" name="type" value="<?= $type; ?>"/>
		   ...
		   <input type="hidden" name="wallet_id" value="<?= $walletsproject->id; ?>"/>
		
		
            <label>
                <label>
					<span class="field"><i class="fa fa-i fa-briefcase"></i>Carteira:</span>
					<input class="radius" type="text" name="wallet_name" value="<?= $walletsproject->wallet; ?>"  readonly/>
				</label>
            </label>
        ...
        <div class="label_check">
            ...
            <label class="check"
                   data-checkbox="true"
                   data-slideup=".cafecontrol_modal_project_<?= $type; ?> .repeate_item_fixed, .cafecontrol_modal_<?= $type; ?> .repeate_item_enrollment">
                <input type="radio" name="repeat_when" value="single" checked> Única
            </label>

            <label data-checkbox="true"
                   data-slideup=".cafecontrol_modal_project_<?= $type; ?> .repeate_item_enrollment"
                   data-slidedown=".cafecontrol_modal_project_<?= $type; ?> .repeate_item_fixed">
                <input type="radio" name="repeat_when" value="fixed"> Fixa
            </label>

            <label data-checkbox="true"
                   data-slideup=".cafecontrol_modal_project_<?= $type; ?> .repeate_item_fixed"
                   data-slidedown=".cafecontrol_modal_project_<?= $type; ?> .repeate_item_enrollment">

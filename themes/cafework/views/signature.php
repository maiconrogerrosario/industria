<form action="<?= $action; ?>" method="post" class="cafecontrol_form">
    <?php if ($plans): ?>
    ...
    <button class="btn radius transition"><i class="fa fa-i fa-check-square-o"></i> <?= ($btn ?? "Confirmar Pagamento"); ?></button>
</form>
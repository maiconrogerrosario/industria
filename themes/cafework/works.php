				...
				<div class="col-xs-12">
					<div class="box">
						...
						<div class="box-body">
							...
							<a href="<?= url("/work/works-add"); ?>" class="btn btn-primary"><i class='fa fa-i fa-plus-circle'></i>Projeto</a>
									...
									<?php if (!empty($works)): ?>
										<?php foreach ($works as $work):?>
											...
											<tr scope="row">	
												...
												<td scope="col" style="text-align:center;font-size:12px;"><?= ($work->date_initial ? date_fmt($work->date_initial, "d/m/Y") : null); ?></td>
												<td scope="col" style="text-align:center;font-size:12px;"><?= ($work->date_final ? date_fmt($work->date_final, "d/m/Y") : null); ?></td>
												...
												<td scope="col" style="text-align:center;font-size:12px;">
													...
													<a title="Editar" href="<?= url("/work/works-edit/{$work->id}"); ?>" class="btn btn-warning btn-xs"><span class="fa fa-edit fw-fa"></span></a>
													<a title="Deletar" class="btn-simple btn btn-danger btn-xs"  href="#"
														data-post="<?= url("/work/works-delete/{$work->id}"); ?>"
														data-action="delete"

...
$route->get("/equipment", "Qrcode:teste");
$route->post("/equipment", "Qrcode:teste");
...
$route->get("/occupation-category/{id}", "App:occupationCategory");
$route->post("/occupation-category/{id}", "App:occupationCategory");
...
$route->get("/equipment-category/{id}", "App:equipmentCategory");
$route->post("/equipment-category/{id}", "App:equipmentCategory");
